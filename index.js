...
const getIdVideo = async (url) => {
  ...
  const matching = url.includes("/photo/");
  if (!matching) {
...
(async () => {
  ...
  // Add string
  let tikTokStr =
    "https://www.tiktok.com/@duplicate_checkuser/photo/7345292753888218369";
  for (var i = 0; i < listVideo.length; i++) {
    if (`${listVideo[i]}` === `${tikTokStr}`) {
      console.log("File existed in the list");
      break;
    }
    console.log(
